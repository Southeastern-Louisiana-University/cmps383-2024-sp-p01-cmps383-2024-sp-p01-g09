...
public class HotelsControllerTests
{
    ...
    public async Task UpdateHotel_NoName_Returns400()
    {
        ...
        //assert
        httpResponse.StatusCode.Should().Be(HttpStatusCode.BadR  equest, "we expect an HTTP 400 when calling PUT /api/hotels/{id} with a missing name");
    }
